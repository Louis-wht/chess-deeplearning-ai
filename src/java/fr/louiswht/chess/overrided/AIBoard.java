...
import chess.gui.Painter;

public final class AIBoard extends Canvas implements chess.board.Board<ArrayMove, ArrayBoard> {
	...
	public AIBoard(AIGamePanel gamePanel) {
